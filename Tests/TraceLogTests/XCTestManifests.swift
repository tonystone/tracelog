...
extension FileWriterFailureReasonTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__FileWriterFailureReasonTests = [
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(FileWriterFailureReasonTests.__allTests__FileWriterFailureReasonTests),
