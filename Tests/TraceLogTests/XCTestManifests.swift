...
extension TextFormatEncodingWithUnicodeTests {
    ...
    static let __allTests__TextFormatEncodingWithUnicodeTests = [
        ...
        ("testJapaneseeucEncodingWithSimpleAsciiMessage", testJapaneseeucEncodingWithSimpleAsciiMessage),
        ("testJapaneseeucEncodingWithUnicodeMessage", testJapaneseeucEncodingWithUnicodeMessage),
        ...
        ("testSymbolEncodingWithSimpleAsciiMessage", testSymbolEncodingWithSimpleAsciiMessage),
        ("testSymbolEncodingWithUnicodeMessage", testSymbolEncodingWithUnicodeMessage),
