...
extension ConcurrencyModeTests {
    ...
    static let __allTests__ConcurrencyModeTests = [
        ("testAsyncConcurrencyModeOptionBufferDefaultParameters", testAsyncConcurrencyModeOptionBufferDefaultParameters),
        ("testAsyncConcurrencyModeOptionEquals", testAsyncConcurrencyModeOptionEquals),
...
extension FileStrategyManagerFailureReasonTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__FileStrategyManagerFailureReasonTests = [
        ("testErrorForAccessdenied", testErrorForAccessdenied),
        ("testErrorForDisconnected", testErrorForDisconnected),
        ("testErrorForInsufficientresources", testErrorForInsufficientresources),
        ("testErrorForInvalidargument", testErrorForInvalidargument),
        ("testErrorForNetworkdown", testErrorForNetworkdown),
        ("testErrorForUnknownerror", testErrorForUnknownerror),
    ]
}

extension FileStrategyTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__FileStrategyTests = [
        ("testFileStrategyDefaultWithDefaultParameters", testFileStrategyDefaultWithDefaultParameters),
        ("testFileStrategyRotateWithDefaultParameters", testFileStrategyRotateWithDefaultParameters),
    ]
}
...
extension FileWriterTests {
    ...
    static let __allTests__FileWriterTests = [
        ("testInitWithDefaults", testInitWithDefaults),
        ("testLogError", testLogError),
        ("testLogInfo", testLogInfo),
        ("testLogTrace1", testLogTrace1),
        ("testLogTrace2", testLogTrace2),
...
extension RawOutputStreamTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__RawOutputStreamTests = [
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(FileStrategyManagerFailureReasonTests.__allTests__FileStrategyManagerFailureReasonTests),
        testCase(FileStrategyTests.__allTests__FileStrategyTests),
        ...
        testCase(RawOutputStreamTests.__allTests__RawOutputStreamTests),
