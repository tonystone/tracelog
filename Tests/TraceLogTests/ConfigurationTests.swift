...
class ConfigurationTests: XCTestCase {
    ...
    func testLogLevel_All_Set_Off() {
        ...
        let _ = configuration.load(environment: ["LOG_ALL": "OFF"])
    ...
    func testLogLevel_All_Set_Error() {
        ...
        let _ = configuration.load(environment: ["LOG_ALL": "ERROR"])
    ...
    func testLogLevel_All_Set_Warning() {
        ...
        let _ = configuration.load(environment: ["LOG_ALL": "WARNING"])
    ...
    func testLogLevel_All_Set_Info() {
        ...
        let _ = configuration.load(environment: ["LOG_ALL": "INFO"])
    ...
    func testLogLevel_All_Set_Trace1() {
        ...
        let _ = configuration.load(environment: ["LOG_ALL": "TRACE1"])
    ...
    func testLogLevel_All_Set_Trace2() {
        ...
        let _ = configuration.load(environment: ["LOG_ALL": "TRACE2"])
    ...
    func testLogLevel_All_Set_Trace3() {
        ...
        let _ = configuration.load(environment: ["LOG_ALL": "TRACE3"])
    ...
    func testLogLevel_All_Set_InvalidLevel() {
        ...
        let _ = configuration.load(environment: ["LOG_ALL": "INVALID"])
